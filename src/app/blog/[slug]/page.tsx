  ...
  return (
    <main className="max-w-3xl mx-auto">
      <header className="mb-8 text-center">
          ...
          <div className="flex justify-center items-center text-gray-500 space-x-4">
            {post.date && <time dateTime={post.date}>{post.date}</time>}
          </div>
          {post.description && <p className="text-xl text-gray-600 mt-4 leading-relaxed">{post.description}</p>}
      </header>
